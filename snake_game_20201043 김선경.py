...
class Game(object):
    ...
    def draw_info(self, length, speed, screen):
        ...
        font_path = resource_path("C:/Users/goeve/Desktop/비미프/4_Snake_Game/assets/NanumGothicCoding-Bold.ttf")
        ...
        for row in range(0, int(GRID_HEIGHT)):
            for col in range(0, int(GRID_WIDTH)):
                if (row+col) % 2 ==0 :
                    ...
                    pygame.draw.rect(screen, PINK1, rect)

                else:
                    rect = pygame.Rect((col*GRID_SIZE, row*GRID_SIZE), (GRID_SIZE, GRID_SIZE))
                    pygame.draw.rect(screen, PINK2, rect)
